...
util.program.spawn_at_startup("start_lemonbar.sh")
util.program.spawn_at_startup("wc-bg")
util.program.spawn_at_startup("udiskie")
util.program.spawn_at_startup("urxvtd")
util.program.spawn_at_startup("dunst")
--util.program.spawn_at_startup("twmnd")
...
way_cooler.windows = {
  ...
  borders = { -- Options for borders
    ...
    size = 5, -- The width of the borders between windows in pixels
  ...
  title_bar = { -- Options for title bar above windows
    ...
    background_color = "003300", -- Color of inactive title bar
    active_background_color = "006600", -- Color of active title bar
    font_color = "dfdfdf", -- Color of the font for an inactive title bar
...
local keys = {
  -- Open dmenu
  key({ mod }, "r", util.program.spawn_once("dmenu_run")),

  -- Open terminal
  key({ mod }, "return", util.program.spawn_once("urxvtc")),
